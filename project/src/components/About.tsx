  ...
  const timeline = [
    {
      ...
      description: 'Leading digital transformation initiatives and providing strategic technical guidance to enterprise clients.'
    },
    {
      year: '2022',
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-6">
            <p className="text-gray-300 leading-relaxed">
              I'm a passionate tech professional with expertise in web development, data analysis, and technical consulting. 
